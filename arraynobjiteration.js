...
// Task 1: Create function to log dairy products
function logDairy() {
    var dairy = ['cheese', 'sour cream', 'milk', 'yogurt', 'ice cream', 'milkshake'];
...
// Task 2: Create function to loop over bird object properties
const animal = {
    canJump: true
};
...
function birdCan() {
    // Get bird's own properties using Object.keys()
    for (let prop of Object.keys(bird)) {
        console.log(`${prop}: ${bird[prop]}`);
    }
}

// Task 3: Create function to loop over all properties including prototype
function animalCan() {
...
console.log("Task 1 - Dairy Products:");
logDairy();

console.log("\nTask 2 - Bird Properties:");
birdCan();

console.log("\nTask 3 - All Animal Properties:");
animalCan();